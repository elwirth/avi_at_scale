...
class OracleAVI:
    ...
    References:
        [1] Wirth, E. S., & Pokutta, S. (2022, May). Conditional gradients for the approximate vanishing ideal. In
        International Conference on Artificial Intelligence and Statistics (pp. 2191-2209). PMLR.
    """
