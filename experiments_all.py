import numpy as np
from global_ import psis_single_, psis_, Cs_, tos_, degrees_, data_sets_performance_, data_sets_time_trials_, Cs_single_
...
def data_driven():
    ...
    hp_pearson_rev = {'algorithm': 'oavi', 'oracle_type': 'CG', 'psi': psis_, 'C': Cs_,
...
def performance():
    ...
    hp_svm = {'algorithm': 'svm', 'C': Cs_, 'degree': degrees_}
...
def time_BPCG_v_IHB_v_WIHB():
    hp_BPCG = {'algorithm': 'oavi', 'oracle_type': 'BPCG', 'psi': psis_single_, 'C': Cs_single_,
               'term_ordering_strategy': tos_, 'inverse_hessian_boost': 'false'}
    hp_WIHB = {'algorithm': 'oavi', 'oracle_type': 'BPCG', 'psi': psis_single_, 'C': Cs_single_,
               'term_ordering_strategy': tos_, 'inverse_hessian_boost': 'weak'}
    hp_IHB = {'algorithm': 'oavi', 'oracle_type': 'CG', 'psi': psis_single_, 'C': Cs_single_,
              'term_ordering_strategy': tos_, 'inverse_hessian_boost': 'full'}
